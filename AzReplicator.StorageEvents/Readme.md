...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *Geppetto.StorageEvents*):

Restore dependencies
```
    cd "Geppetto.StorageEvents"
    dotnet restore
```

Execute unit tests
```
    cd "Geppetto.StorageEvents/test/Geppetto.StorageEvents.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Geppetto.StorageEvents/src/Geppetto.StorageEvents"
